...
const { isLoggedIn, isAdmin,isIdValid, validateAmmenity } = require("../../middleware");

router
  .route("/")
  .get(isLoggedIn, isAdmin, ammenityController.index)
  .post(isLoggedIn, isAdmin,validateAmmenity, catchAsync(ammenityController.store));
...
router
  ...
  .delete(isLoggedIn, isAdmin,isIdValid, catchAsync(ammenityController.delete));
